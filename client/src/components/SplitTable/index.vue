<template>
  <div class="title">
    ...
    <div class="demo-input-suffix fl">
      <el-input v-model="input21" placeholder="请输入APP名称或运营商名称" prefix-icon="el-icon-search" />
    </div>
      ...
      >
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button v-if="istag" type="primary" icon="el-icon-star-on" @click="switchChange" />
            <el-button v-else type="primary" icon="el-icon-star-off" @click="switchChange" />
          </template>
        </el-table-column>
      </el-table>
      <el-pagination class="fy" layout="prev, pager, next" :total="total" background @current-change="current_change" />
    </div>
  </div>
</template>
