        ...
        try:
            ...
            while True:
                if self.__writer is None:
                    # Only tests anything if there is no current writer.
        ...
        try:
            ...
            while True:
                if not self.__readers and self.__writer is None:
                    # Only tests anything if there are no readers and writers.
                    if self.__upgradewritercount:
                        if upgradewriter:
                ...
                if timeout is not None:
                    ...
                    if remaining <= 0:
                        ...
                        if upgradewriter:
                            ...
                            # here (because of remaining readers), as the tests
